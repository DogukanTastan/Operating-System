...
namespace myos
{
    namespace hardwarecommunication
    {
        ...
        protected:
            ...
            common::uint32_t sys_getPid();
            common::uint32_t sys_fork(CPUState *cpu);
            common::uint32_t sys_exec(common::uint32_t entrypoint);
           // common::uint32_t sys_addTask(common::uint32_t entrypoint);
            bool sys_waitPid(common::uint32_t wPid);
            bool sys_exit();
